...
if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $sql = "SELECT * FROM transaksi WHERE deskripsi LIKE '%$search%' OR tanggal LIKE '%$search%' OR jumlah LIKE '%$search%'OR tipe LIKE '%$search%'";
} else {
...
<body>
        ...
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <a class="btn-transaksi" href="create.php">Tambah Transaksi</a
    ...
    <footer>
        <p>&copy; 2025 Akuntansi Keuangan</p>
    </footer>
</body>
</html>